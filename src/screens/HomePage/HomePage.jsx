  ...
  return (
    <div className="home-page-div">
      ...
      <div className="home-buttons-div">
        ...
        {!isEmpty(user) && <Fragment>
          <div className="home-button-panel">
            <p>Tous vos paris : </p>
            <Button className="home-button" onClick={() => history.push('/matches')} color="primary">
          ...
          <div className="home-button-panel">
            ...
            <Button className="home-button" onClick={() => history.push('/ranking')} color="primary">
